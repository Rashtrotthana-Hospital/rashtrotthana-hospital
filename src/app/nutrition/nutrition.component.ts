...
export class NutritionComponent {
  ...
  facilities = [
    {
      main_heading: 'Clinical Nutrition & Dietetics',
      heading: 'Clinical Nutrition & Dietetics',
  ...
  doctors = [
    {
      doctor_image: 'assets/new-doctor-imgs/Ms-Archana-Karthick.png',
    ...
    },
    {
      ...
      experience: "3+",
      docalt: 'Ms. Dharanika Devaraj | Best Clinical Dietitian in Bangalore | Rashtrotthana Hospital | Rajarajeshwari Nagar Bangalore'
    },
    {
      doctor_image: 'assets/new-doctor-imgs/JMRH-Dr-bilwashree-img.png',
      doctor_name: 'Ms. Bilwashree Hegde',
      experience: "1",
      docalt: 'Ms. Bilwashree Hegde | Best Clinical Dietitian in Bangalore | Rashtrotthana Hospital | Rajarajeshwari Nagar Bangalore'
    },
