...
export class AnesthesiologyComponent {
  ...
  ngOnInit(): void {
    this.titleService.setTitle("Best Anesthesiology Hospital in Bangalore| Rashtrotthana Hospital ");  

  this.metaService.updateTag({ name: 'description', content: 'Safe anesthesia and pain management services in Bangalore with experienced anesthesiologists supporting surgeries and critical care at Rashtrotthana Hospital.' });
