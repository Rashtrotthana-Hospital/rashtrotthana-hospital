...
export class NewDoctorPageComponent {
  ...
  allDoctors = [
    ...
    },
    {
      ...
      expertise: '19+',
      qualification: `MBBS, DGO, DNB, FELLOWSHIP IN MATERNAL <br> FETAL MEDICINE`,
    ...
    },
    {
      ...
      description: 'Dr. Nikhil Hegde is an orthopedic surgeon with 10 years of experience, specializing in sports medicine, arthroplasty, arthroscopy and trauma care.',
      faqs: [
        {
   ...
   
    {
      ...
      expertise: "11+",
      qualification: `MBBS, MD (Internal Medicine) DM (Clinical Immunology and <br> Rheumatology) MRCP-SCE (UK) Rheumatology,<br> EULAR Fellow`,
      time: "",
      date: "Monday, Wednesday and Friday",
      alt: '',
      id: 57,
    ...
    },
    {
      ...
      qualification: `MD (General Medicine), 
        MBBS, <br> Fellowship in Diabetology,
